...
  href: string // AHORA ESTO ES LA RUTA REAL
  badge?: string
}
...
    items: [
      // RUTA DEL DASHBOARD HOME (index)
      { title: "Inicio", icon: Users, href: "/dashboard" }, 
    ],
  },
  {
    section: "Estudiantes",
    items: [
      // 🎯 ESTA RUTA DEBE COINCIDIR CON <Route path="students" ... /> en App.tsx
      { title: "Gestionar Estudiantes", icon: UserPlus, href: "/dashboard/students" },
      // Si quieres sub-vistas anidadas:
      // { title: "Listar Estudiantes", icon: Users, href: "/dashboard/students/list" },
      // { title: "Asignar a Cursos", icon: UserCheck, href: "/dashboard/students/assign" },
    ],
  },
  {
    section: "Profesores",
    items: [
      // 🎯 ESTA RUTA DEBE COINCIDIR CON <Route path="teachers" ... /> en App.tsx
      { title: "Gestionar Profesores", icon: GraduationCap, href: "/dashboard/teachers" },
      { title: "Asignar a Cursos", icon: UserCheck, href: "#" }, // Mantengo # aquí si no tienes la vista aún
    ],
  },
  {
...
  }
  ...
  const isLinkActive = (href: string) => {
    // Si la ruta es la raíz del dashboard, debe coincidir exactamente.
    if (href === '/dashboard') {
      return pathname === '/dashboard';
    }
    // Para otras rutas, verifica si el pathname comienza con el href.
    // Esto significa que '/dashboard/students/register' activará '/dashboard/students'
    if (href !== '#') {
...
                  // Usamos la nueva función de verificación de estado activo
